package com.example.searchphone.LjxRedis;
...
@Service
public class RedisString extends com.example.searchphone.LjxRedis.RedisTemplate {
     ...
     * @return
     */
    public Map<String, String> getPhoneList(String key) {
        Jedis jedis = this.getJedis();
